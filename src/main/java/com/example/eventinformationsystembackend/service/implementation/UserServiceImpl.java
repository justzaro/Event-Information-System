...
public class UserServiceImpl implements UserService {
    ...
    public UserDtoResponse registerUser(UserDto userDto) {
        ...
        storageServiceImpl.createFolder(userFolderPath);
        storageServiceImpl.createFolder(userPostsFolderPath);
        ...
        String confirmationToken =
                confirmationTokenServiceImpl.createToken(userToRegister);
        String confirmationLink =
                CONFIRMATION_LINK + confirmationToken;

        emailServiceImpl.sendConfirmationEmail(userToRegister, confirmationLink);
    ...
    public UserDtoResponse updateUser(UserUpdateDto userUpdateDto, String username,
        ...
        if (!user.getUsername().equals(userUpdateDto.getUsername())) {
            ...
            storageServiceImpl.renameFolder(currentUserFolderPath, newUserFolderPath);
            ...
            postServiceImpl.replaceOldUsernameWithNewOneInPicturePathForAllUserPosts(username,
        ...
        if (profilePicture != null && !profilePicture.isEmpty()) {
            ...
            && !user.getProfilePictureName().equals(DEFAULT_USER_PROFILE_PICTURE_NAME)) {
                storageServiceImpl.deleteFile(user.getProfilePicturePath());
            }
            System.out.println(profilePicture.getOriginalFilename());
            String newUserProfilePicturePath = newUserFolderPath + "\\"
                    + profilePicture.getOriginalFilename();

            storageServiceImpl.savePictureToFileSystem(profilePicture, newUserProfilePicturePath);
        ...
        user.setCreditCardNumber(userUpdateDto.getCreditCardNumber());
        user.setCreditCardCvv(userUpdateDto.getCreditCardCvv());
    ...
    public void deleteUser(String username) {
        ...
        storageServiceImpl.deleteFolder(userFolderPath);
